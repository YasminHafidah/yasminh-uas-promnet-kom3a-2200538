...
const Update = () =>{
    ...
    const updateUser = async (e) =>{
        ...
        try{
            ...
            await ConnectBackend.UpdateUser(id, {
            nama,
            usia: usiaInt,
            jenis_kelamin,
            alamat,
    ...
    const getUserById = async () => {
        const response = await ConnectBackend.getUserById(id);
        ...
        return(
            ...
            <h3 className="font-bold text-center mt-3 bg-[#6eaa5e] p-5">Perbarui Data Pasien</h3>
